#include "include/GPS_Navigation.h"
...
void gps_parse_nmea(void)
{
  ...
  static unsigned char unlock=1; //some kind of event flag
  static unsigned char checksum=0; //the checksum generated
  static unsigned char checksum_received=0; //Checksum received
  static unsigned char counter=0; //general counter

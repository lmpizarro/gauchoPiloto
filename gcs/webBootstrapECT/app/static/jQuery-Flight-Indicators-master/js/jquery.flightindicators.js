...
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		var settings = $.extend({
			...
			pressure: 1000,
			showBox : true,
			//img_directory : Flask.url_for('static', filename='jQuery-Flight-Indicators-master/img/')
			img_directory : "/static/jQuery-Flight-Indicators-master/img/" 
		}, options );
		var constants = {
			pitch_bound:30,
			vario_bound : 1.95,
		...
		placeholder.each(function(){
                ...
                console.log("....",settings.img_directory);
			switch(type){
				case 'heading':
